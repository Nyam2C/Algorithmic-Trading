"""
BotInstance 커버리지 향상 테스트

기존 테스트에서 커버하지 못한 라인들을 집중적으로 테스트합니다:
- Redis 상태 동기화/복구
- AI 메모리 시그널 생성
- 포지션 클로즈 + 리스크 관리
- 트레이딩 루프 (emergency close, regime filter 등)
- 콜백 에러 핸들링
- 생명주기 (start/stop/cleanup)
"""
import asyncio
...
class TestRedisSyncState:
    ...
    @pytest.mark.asyncio
    async def test_sync_state_to_redis_no_position(self, bot_config, mock_redis_manager):
        """포지션 없이 Redis 상태 동기화"""
    ...
    @pytest.mark.asyncio
    async def test_sync_state_to_redis_with_position(self, bot_config, mock_redis_manager):
    ...
    @pytest.mark.asyncio
    async def test_sync_state_to_redis_no_manager(self, bot_config):
        """Redis 관리자가 없을 때 동기화 스킵"""
        instance = _create_instance(bot_config)
        # redis_state_manager가 None이면 바로 리턴
        await instance._sync_state_to_redis()
        # 에러 없이 완료

    @pytest.mark.asyncio
    async def test_sync_state_to_redis_exception(self, bot_config, mock_redis_manager):
    ...
    @pytest.mark.asyncio
    async def test_restore_state_from_redis_no_manager(self, bot_config):
    ...
    @pytest.mark.asyncio
    async def test_restore_state_from_redis_with_state(self, bot_config, mock_redis_manager):
        """Redis에서 봇 상태 복구"""
    ...
    @pytest.mark.asyncio
    async def test_restore_state_from_redis_with_position(self, bot_config, mock_redis_manager):
    ...
    @pytest.mark.asyncio
    async def test_restore_state_from_redis_exception(self, bot_config, mock_redis_manager):
        """Redis 상태 복구 실패"""
    ...
    @pytest.mark.asyncio
    async def test_restore_state_no_saved_state(self, bot_config, mock_redis_manager):
        """Redis에 저장된 상태가 없을 때"""
    ...
    def test_set_redis_state_manager(self, bot_config, mock_redis_manager):
        """Redis 상태 관리자 설정"""
        instance = _create_instance(bot_config)
...
class TestMemorySignals:
    ...
    def test_memory_signals_enabled_true(self, bot_config, mock_enhanced_gemini):
        """메모리 시그널 활성화 상태 확인"""
        instance = _create_instance(
            bot_config,
    ...
    def test_memory_signals_enabled_false_no_gemini(self, bot_config):
    ...
    def test_memory_signals_enabled_false_not_set(self, bot_config, mock_enhanced_gemini):
    ...
    def test_enable_memory_signals_success(self, bot_config, mock_enhanced_gemini):
        """메모리 시그널 활성화 성공"""
        instance = _create_instance(
            bot_config,
            enhanced_gemini=mock_enhanced_gemini,
    ...
    def test_enable_memory_signals_no_gemini(self, bot_config):
    ...
    def test_disable_memory_signals(self, bot_config, mock_enhanced_gemini):
        """메모리 시그널 비활성화"""
        instance = _create_instance(
            bot_config,
            enhanced_gemini=mock_enhanced_gemini,
    ...
    def test_set_enhanced_gemini(self, bot_config, mock_enhanced_gemini):
        """EnhancedGemini 설정"""
        instance = _create_instance(bot_config)
    ...
    @pytest.mark.asyncio
    async def test_generate_signal_with_memory_success(self, bot_config, mock_enhanced_gemini):
        """메모리 기반 시그널 생성 성공"""
    ...
    @pytest.mark.asyncio
    async def test_generate_signal_with_memory_fallback_no_gemini(self, bot_config):
    ...
    @pytest.mark.asyncio
    async def test_generate_signal_with_memory_invalid_signal(self, bot_config, mock_enhanced_gemini):
    ...
    @pytest.mark.asyncio
    async def test_generate_signal_with_memory_exception(self, bot_config, mock_enhanced_gemini):
...
class TestSignalGeneration:
    ...
    def test_generate_signal_valid(self, bot_config):
        """유효한 시그널 생성"""
        instance = _create_instance(bot_config)
    ...
    def test_generate_signal_invalid_signal_becomes_wait(self, bot_config):
...
class TestInitialization:
    ...
    @pytest.mark.asyncio
    async def test_initialize_with_binance_client(self, bot_config, mock_binance_client):
    ...
    @pytest.mark.asyncio
    async def test_initialize_creates_binance_client_if_none(self, bot_config):
    ...
    @pytest.mark.asyncio
    async def test_initialize_with_database_url(self, bot_config, mock_binance_client):
    ...
    @pytest.mark.asyncio
    async def test_initialize_db_connection_failure(self, bot_config, mock_binance_client):
        """DB 연결 실패 시 에러 로그"""
        instance = _create_instance(
            bot_config,
            binance_client=mock_binance_client,
    ...
    async def test_initialize_with_memory_signals(
        self, bot_config, mock_binance_client, mock_trade_db, mock_enhanced_gemini
    ):
        """메모리 시그널과 함께 초기화"""
        instance = _create_instance(
            bot_config,
    ...
    async def test_initialize_memory_signals_create_gemini(
        self, bot_config, mock_binance_client, mock_trade_db
    ):
    ...
    async def test_initialize_with_redis(
        self, bot_config, mock_binance_client, mock_redis_manager
    ):
    ...
    async def test_initialize_risk_manager_balance_failure(
        self, bot_config, mock_binance_client
    ):
...
class TestCleanup:
    ...
    @pytest.mark.asyncio
    async def test_cleanup_with_redis(self, bot_config, mock_redis_manager):
        """Redis가 있을 때 cleanup"""
        instance = _create_instance(
            bot_config,
            redis_state_manager=mock_redis_manager,
    ...
    @pytest.mark.asyncio
    async def test_cleanup_with_trade_db(self, bot_config, mock_trade_db):
        ...
        mock_trade_db.disconnect.assert_called_once()

    @pytest.mark.asyncio
    async def test_cleanup_no_dependencies(self, bot_config):
        """의존성 없이 cleanup"""
        instance = _create_instance(bot_config)
        await instance._cleanup()
        # 에러 없이 완료
...
class TestFetchMarketData:
    ...
    @pytest.mark.asyncio
    async def test_fetch_market_data_no_client(self, bot_config):
...
class TestPositionManagement:
    ...
    @pytest.mark.asyncio
    async def test_open_position_no_executor(self, bot_config):
    ...
    @pytest.mark.asyncio
    async def test_close_position_no_executor(self, bot_config):
    ...
    async def test_open_position_with_db_and_callback(
        ...
        mock_trade_db.add_entry.assert_called_once()
    ...
    async def test_close_position_with_pnl_tracking(
        ...
        assert result is not None
        mock_trade_db.add_exit.assert_called_once()
        on_trade.assert_called_once()
...
class TestCallbackErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_notify_signal_callback_error(self, bot_config):
        """시그널 콜백 에러 핸들링"""
    ...
    @pytest.mark.asyncio
    async def test_notify_trade_callback_error(self, bot_config):
        """거래 콜백 에러 핸들링"""
    ...
    @pytest.mark.asyncio
    async def test_notify_error_callback_error(self, bot_config):
        """에러 콜백 자체가 에러 발생"""
    ...
    @pytest.mark.asyncio
    async def test_notify_error_no_callback(self, bot_config):
        """에러 콜백이 없을 때"""
        instance = _create_instance(bot_config)
        await instance._notify_error(RuntimeError("test error"))

    @pytest.mark.asyncio
    async def test_notify_signal_no_callback(self, bot_config):
        """시그널 콜백이 없을 때"""
        instance = _create_instance(bot_config)
        await instance._notify_signal("LONG", 50000.0)

    @pytest.mark.asyncio
    async def test_notify_trade_no_callback(self, bot_config):
        """거래 콜백이 없을 때"""
        instance = _create_instance(bot_config)
        await instance._notify_trade("OPEN", "LONG", 50000.0, None)

    @pytest.mark.asyncio
    async def test_notify_risk_halt(self, bot_config):
        """리스크 한도 알림"""
        on_error = AsyncMock()
        instance = _create_instance(
            bot_config,
    ...
    @pytest.mark.asyncio
    async def test_notify_risk_halt_callback_error(self, bot_config):
        """리스크 알림 시 콜백 에러"""
        on_error = AsyncMock(side_effect=Exception("callback error"))
        instance = _create_instance(
            bot_config,
    ...
    @pytest.mark.asyncio
    async def test_notify_risk_halt_no_callback(self, bot_config):
        """리스크 알림 콜백 없을 때"""
        instance = _create_instance(bot_config)
        await instance._notify_risk_halt("일일 손실 한도 초과")
...
class TestTradingLoop:
    ...
    async def test_execute_single_loop_with_memory_signals(
        self, bot_config, mock_binance_client, mock_enhanced_gemini
    ):
...
class TestLifecycle:
    ...
    @pytest.mark.asyncio
    async def test_run_loop_executes_and_stops(self, bot_config, mock_binance_client):
    ...
    @pytest.mark.asyncio
    async def test_run_loop_handles_exception(self, bot_config, mock_binance_client):
        """루프 중 에러 발생 시 계속 실행"""
        instance = _create_instance(
            bot_config,
            binance_client=mock_binance_client,
    ...
    @pytest.mark.asyncio
    async def test_start_and_stop(self, bot_config, mock_binance_client):
        """start/stop 전체 생명주기"""
        instance = _create_instance(
            bot_config,
            binance_client=mock_binance_client,
    ...
    @pytest.mark.asyncio
    async def test_start_cancelled(self, bot_config, mock_binance_client):
        """태스크 취소 시 cleanup 호출"""
        instance = _create_instance(
            bot_config,
            binance_client=mock_binance_client,
    ...
    @pytest.mark.asyncio
    async def test_stop_sets_running_false(self, bot_config):
    ...
    @pytest.mark.asyncio
    async def test_run_loop_with_redis_sync(self, bot_config, mock_binance_client, mock_redis_manager):
        """루프 실행 중 Redis 동기화"""
        instance = _create_instance(
            bot_config,
            binance_client=mock_binance_client,
...
class TestProperties:
    ...
    def test_bot_name(self, bot_config):
        """bot_name 프로퍼티"""
        instance = _create_instance(bot_config)
        assert instance.bot_name == "coverage-bot"

    def test_symbol(self, bot_config):
        """symbol 프로퍼티"""
        instance = _create_instance(bot_config)
        assert instance.symbol == "BTCUSDT"

    def test_is_running(self, bot_config):
        """is_running 프로퍼티"""
        instance = _create_instance(bot_config)
        assert instance.is_running is False

    def test_is_paused(self, bot_config):
        """is_paused 프로퍼티"""
        instance = _create_instance(bot_config)
        assert instance.is_paused is False

    def test_get_state_includes_all_fields(self, bot_config):
