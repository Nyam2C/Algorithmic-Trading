...
# =========================================================================
# Issue K: get_position() retry decorator
# =========================================================================
...
class TestIssueKGetPositionRetry:
    ...
    @pytest.mark.asyncio
    async def test_get_position_retries_on_connection_error(self, client):
        """get_position retries on ConnectionError and succeeds."""
        client._client.futures_position_information = AsyncMock(
            side_effect=[
        ...
        assert client._client.futures_position_information.call_count == 2

    @pytest.mark.asyncio
    async def test_get_position_retries_on_timeout_error(self, client):
    ...
    @pytest.mark.asyncio
    async def test_get_position_no_circuit_breaker(self, client):
...
# =========================================================================
# Issue L: Split circuit breakers
# =========================================================================
